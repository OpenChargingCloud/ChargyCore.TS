...
export function parseUTC(UTCTime: string|number): Moment {
...
export function SetTimestamp32(dv: DataView, timestamp: string | Moment | undefined, offset: number, addLocalOffset: boolean = true): string
{
